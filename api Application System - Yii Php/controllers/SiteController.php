...
class SiteController extends Controller
{
    ...
    public function actionProjects()
    {
        ...
        return $this->render('projects', ['posts' => $posts]);
    }
    ...
    public function actionCreatemodules(){
        ...
        return $this->render('createmodules', ['module' => $module]);
    }

    public function actionViewmodules($id){
        // echo $id;
        $module = Modules::findOne($id);
        return $this->render('viewmodules', ['module' => $module]);
    }
    ...
    public function actionUpdatemodules($id){
        ...
        if($module->load(Yii::$app->request->post()) && $module->save() ){
            ...
            return $this->render('updatemodules', ['module' => $module]);
        }
        return $this->render('updatemodules', ['module' => $module]);
    ...
    public function actionCreateapis(){
        ...
        return $this->render('createApis', ['api' => $api]);
        // echo "api create!";
    }
    ...
    public function actionViewapis($id){
        // echo $id;
        $api = Apis::findOne($id);
        return $this->render('viewapis', ['api' => $api]);
    }
    ...
    public function actionUpdateapis($id){
        ...
        if($api->load(Yii::$app->request->post()) && $api->save() ){
            ...
            return $this->render('updateapis', ['api' => $api]);
        }
        return $this->render('updateapis', ['api' => $api]);
    ...
    public function actionCreateusers(){
        ...
        return $this->render('createUsers', ['user' => $user]);
        // echo "api create!";
    }
    ...
    public function actionViewusers($id){
        ...
        return $this->render('viewusers', ['user' => $user]);
    }
    ...
    public function actionUpdateusers($id){
        ...
        if($user->load(Yii::$app->request->post()) && $user->save() ){
            ...
            return $this->render('updateusers', ['user' => $user]);
        }
        return $this->render('updateapis', ['user' => $user]);
